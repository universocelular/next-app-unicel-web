        ...
        {applicableServices.map((service, index) => (
          ...
          >
            <button onClick={() => handleSelect(service)} className="w-full h-full text-left">
              <Card className="h-full flex flex-col justify-center items-center text-center border-2 border-border/20 hover:border-secondary dark:!border-2 dark:!border-primary dark:hover:!border-primary/80 transition-colors duration-300 p-2 overflow-hidden">
