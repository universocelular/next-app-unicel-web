    ...
    <div className="relative flex items-center justify-center min-h-screen bg-background p-4">
        ...
        <div className="w-full max-w-sm">
          <div className="grid gap-2 text-center">
             <Link href="/" className="flex flex-col items-center justify-center gap-1 mb-4">
              <EnhancedLogo
                width={192}
                height={192}
                className="h-48 w-48"
                priority
              />
              <h1 className="text-3xl font-bold tracking-tight text-primary">UNIVERSO CELULAR</h1>
            </Link>
          </div>
